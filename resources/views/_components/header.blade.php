    ...
    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
        <a href="{{ url('home') }}">
            <img alt="Logo" src="{{ asset('assets/media/logos/default.svg') }}"
                class="h-20px h-lg-25px app-sidebar-logo-default theme-light-show" />
            <img alt="Logo" src="{{ asset('assets/media/logos/default-dark.svg') }}"
                class="h-20px h-lg-25px app-sidebar-logo-default theme-dark-show" />
        </a>
    </div>
    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="px-2 my-5 menu menu-rounded menu-column menu-lg-row my-lg-0 align-items-stretch fw-semibold px-lg-0"
                ...
                <div data-kt-menu-placement="bottom-start"
                    ...
                    <a class="menu-link" href="{{ url('home') }}">
                        <span class="menu-title"> <i class="fas fa-home"></i> &nbsp; {{ __('Home') }}</span>
                        <span class="menu-arrow d-lg-none"></span>
                    </a>
                </div>
                @if (Auth::allowedUri('roles.list') ||
                        Auth::allowedUri('priveleges.list') ||
                        Auth::allowedUri('user.list') ||
                        Auth::allowedUri('sysparams.list'))
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                        class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2 parents">
                        <span class="menu-link child">
                            <span class="menu-title">{{ __('Master Data') }}</span>
                            <span class="menu-arrow d-lg-none"></span>
                        </span>
                        <div
        ...
        <div class="flex-shrink-0 app-navbar">
            ...
            <div class="app-navbar-item ms-1 ms-lg-3">
                ...
                <!--begin::Menu toggle-->
                <!--begin::Menu-->
                <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold fs-base w-175px"
            ...
            <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                ...
                <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-275px"
                    ...
                    <div class="px-5 menu-item d-flex">
                        <a href="{{ url('user/profile') }}" class="px-5 menu-link">{{ __('My Profile') }}</a>
                    </div>
                    <div class="px-5 menu-item">
                        <a href="{{ url('user/reset_password') }}"
                            class="px-5 menu-link">{{ __('Update Password') }}</a>
                    </div>
                    <div class="my-2 separator"></div>
                    <div class="px-5 menu-item" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <a href="#" class="px-5 menu-link">
                            <span class="menu-title position-relative">{{ __('Language') }}
                                <span
                                    class="px-3 py-2 rounded fs-8 bg-light position-absolute translate-middle-y top-50 end-0">{{ strtoupper(App::getLocale()) }}
                                    <img class="w-15px h-15px rounded-1 ms-2"
                                        src="{{ asset($flags[App::getLocale()]) }}" alt="" /></span></span>
                        </a>
                        <div class="py-4 menu-sub menu-sub-dropdown w-175px">
                            @foreach (Config::get('languages') as $lang => $language)
                                <div class="px-3 menu-item">
                                    <a href="{{ url('lang', $lang) }}"
                                        class="menu-link d-flex px-5 {{ $lang == App::getLocale() ? 'active' : '' }}">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1" src="{{ asset($flags[$lang]) }}"
                                                alt="" />
                                        </span>{{ $language }}</a>
                                </div>
                            @endforeach
