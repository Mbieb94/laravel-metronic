...
<html lang="en">
	...
	<head><base href=""/>
		...
		<link href="{{ asset('assets/css/custom/custom.css') }}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" class="bg-body position-relative app-blank">
        <div class="app-page-loader page-loader-logo d-block app-page-loader-web">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
            ...
            <!--begin::Menu Bar-->
            @include('web.components.menu-bar')
			...
			<div class="mb-n10 mb-lg-n20 z-index-2 mt-10">
				...
				<div class="container">
					...
					<div class="text-center mb-17">
						<!--begin::Title-->
						<h3 class="fs-2hx text-dark mb-5" id="how-it-works" data-kt-scroll-offset="{default: 100, lg: 150}">{{ __('Visi, Misi dan Tujuan') }}</h3>
						<!--end::Title-->
						<!--begin::Text-->
					...
					<div class="row g-10">
                        ...
                        <div class="col-xl-4">
                            <div class="card d-flex h-100 align-items-center">
                                <!--begin::Option-->
                                <div class="card-body w-100 d-flex flex-column flex-center rounded-3 bg-body py-15 px-10">
                                    <!--begin::Heading-->
                                    <div class="mb-7 text-center">
                                        <!--begin::Title-->
                                        <h1 class="text-dark mb-5 fw-boldest">Visi</h1>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                        ...
                        <div class="col-xl-4">
                            <div class="card d-flex h-100 align-items-center">
                                <!--begin::Option-->
                                <div class="card-body w-100 d-flex flex-column flex-center rounded-3 bg-primary py-20 px-10">
                                    <!--begin::Heading-->
                                    <div class="mb-7 text-center">
                                        <!--begin::Title-->
                                        <h1 class="text-white mb-5 fw-boldest">Misi</h1>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                        ...
                        <div class="col-xl-4">
                            <div class="card d-flex h-100 align-items-center">
                                <div class="card-body w-100 d-flex flex-column flex-center rounded-3 bg-body py-15 px-10">
                                    ...
                                    <div class="mb-7 text-center">
                                        <!--begin::Title-->
                                        <h1 class="text-dark mb-5 fw-boldest">Tujuan</h1>
                                        <!--end::Title-->
                                        <!--begin::Description-->
					...
					<div class="card" style="filter: drop-shadow(0px 0px 40px rgba(68, 81, 96, 0.08))">
						...
						<div class="card-body p-lg-20">
							...
							<div class="text-center mb-5 mb-lg-10">
								<!--begin::Title-->
								<h3 class="fs-2hx text-dark mb-5" id="portfolio" data-kt-scroll-offset="{default: 100, lg: 250}">{{ __('Galery') }}</h3>
								<!--end::Title-->
							</div>
							<!--end::Heading-->
							<!--begin::Tabs wrapper-->
            ...
            <div class="mt-20 mb-n20 position-relative z-index-2">
				@include('web.sections.locations')
            </div>
			<div class="mt-20 mb-n20 position-relative z-index-2">
				<!--begin::Container-->
				<div class="container">
