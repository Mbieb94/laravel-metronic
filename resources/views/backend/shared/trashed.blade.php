...
@section('meta')
    ...
    <meta name="permission" restore="{{ Auth::allowedUri(Request::segment(1) . '.restore') ? true : false }}"
        delete="{{ Auth::allowedUri(Request::segment(1) . '.delete') ? true : false }}">
        ...
        <div class="card-header pt-7">
            ...
            <div class="d-flex justify-content-end align-items-center d-none" data-kt-user-table-toolbar="selected">
                ...
                <button type="button" class="btn btn-danger"
                    data-kt-user-table-select="hard_delete_selected">{{ __('Delete Selected') }}</button>
            </div>
            <!--end::Toolbar-->
        </div>
